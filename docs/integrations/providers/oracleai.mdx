...
Oracle AI 向量搜索的最大好处之一是，非结构化数据的语义搜索可以与业务数据的关系搜索在一个系统中结合。
 ...
 * [真实应用集群的可扩展性](https://www.oracle.com/database/real-application-clusters/)
 ...
 * [Oracle 空间和图](https://www.oracle.com/database/spatial/)
