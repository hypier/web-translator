...
本笔记本介绍了如何使用 Manifest 和 LangChain。

有关 `manifest` 的更详细信息，以及如何在本示例中与本地 huggingface 模型一起使用它，请参见 https://github.com/HazyResearch/manifest

另一个 [使用 Manifest 和 Langchain 的示例](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html)。
