...
该模板创建一个代理，使用 OpenAI 函数调用来传达其采取的行动决策。

此示例创建一个代理，可以选择使用 Tavily 的搜索引擎查找互联网上的信息。
...
我们可以在 [http://127.0.0.1:8000/openai-functions-agent/playground](http://127.0.0.1:8000/openai-functions-agent/playground) 访问游乐场  
