...
如果您在此目录内，则可以直接通过以下命令启动一个 LangServe 实例：
...
我们可以在 [http://127.0.0.1:8000/rag-lancedb/playground](http://127.0.0.1:8000/rag-lancedb/playground) 访问游乐场  
